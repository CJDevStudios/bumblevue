 ...
 *
 * [Live Demo](https://www.bumblevue.org/datepicker/)
 *
 * @module datepicker
 *
 */
...
import type { ButtonPassThroughOptions, ButtonProps } from '@cjdevstudios/bumblevue/button';
...
export interface DatePickerProps {
    ...
    /**
     * Format of the date. Defaults to BumbleVue locale configuration.
     */
...
/**
 * **BumbleVue - DatePicker**
 *
 * _DatePicker  is a form component to work with dates._
 *
 * [Live Demo](https://www.bumblevue.org/calendar/)
 *
 * @group Component
 *
 */
