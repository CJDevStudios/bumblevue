...
<script>
import { addClass, focus, isAttributeEquals } from '@cjdevstudios/bumbleuix-utils/dom';
import { ZIndex } from '@cjdevstudios/bumbleuix-utils/zindex';
import EyeIcon from '@cjdevstudios/bumblevue-icons/eye';
import RefreshIcon from '@cjdevstudios/bumblevue-icons/refresh';
import SearchMinusIcon from '@cjdevstudios/bumblevue-icons/searchminus';
import SearchPlusIcon from '@cjdevstudios/bumblevue-icons/searchplus';
import TimesIcon from '@cjdevstudios/bumblevue-icons/times';
import UndoIcon from '@cjdevstudios/bumblevue-icons/undo';
import FocusTrap from '@cjdevstudios/bumblevue/focustrap';
import Portal from '@cjdevstudios/bumblevue/portal';
import { blockBodyScroll, unblockBodyScroll } from '@cjdevstudios/bumblevue/utils';
...
export default {
    ...
    methods: {
        ...
        onBeforeEnter() {
            ZIndex.set('modal', this.mask, this.$bumblevue.config.zIndex.modal);
        },
        onEnter() {
            this.focus();
            this.$emit('show');
    ...
    computed: {
        ...
        rightAriaLabel() {
            return this.$bumblevue.config.locale.aria ? this.$bumblevue.config.locale.aria.rotateRight : undefined;
        },
        leftAriaLabel() {
            return this.$bumblevue.config.locale.aria ? this.$bumblevue.config.locale.aria.rotateLeft : undefined;
        },
        zoomInAriaLabel() {
            return this.$bumblevue.config.locale.aria ? this.$bumblevue.config.locale.aria.zoomIn : undefined;
        },
        zoomOutAriaLabel() {
            return this.$bumblevue.config.locale.aria ? this.$bumblevue.config.locale.aria.zoomOut : undefined;
        },
        zoomImageAriaLabel() {
            return this.$bumblevue.config.locale.aria ? this.$bumblevue.config.locale.aria.zoomImage : undefined;
        },
        closeAriaLabel() {
            return this.$bumblevue.config.locale.aria ? this.$bumblevue.config.locale.aria.close : undefined;
        }
    },
    components: {
        Portal: Portal,
