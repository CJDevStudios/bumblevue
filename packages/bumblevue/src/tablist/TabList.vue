...
import { findSingle, getHeight, getOffset, getOuterHeight, getOuterWidth, getWidth, isRTL } from '@cjdevstudios/bumbleuix-utils/dom';
...
export default {
    ...
    computed: {
        ...
        prevButtonAriaLabel() {
            return this.$bumblevue.config.locale.aria ? this.$bumblevue.config.locale.aria.previous : undefined;
        },
        nextButtonAriaLabel() {
            return this.$bumblevue.config.locale.aria ? this.$bumblevue.config.locale.aria.next : undefined;
        },
        dataP() {
            return cn({
