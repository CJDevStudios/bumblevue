...
<script>
import { getWindowScrollTop } from '@cjdevstudios/bumbleuix-utils/dom';
...
export default {
    ...
    computed: {
        scrollTopAriaLabel() {
            return this.$bumblevue.config.locale.aria ? this.$bumblevue.config.locale.aria.scrollTop : undefined;
        }
    },
    components: {
        ChevronUpIcon,
