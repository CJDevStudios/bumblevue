import { style } from '@cjdevstudios/bumbleuix-styles/inputchips';
...
const classes = {
    ...
    input: ({ props, instance }) => [
        'p-inputchips-input',
        {
            'p-variant-filled': props.variant ? props.variant === 'filled' : instance.$bumblevue.config.inputStyle === 'filled' || instance.$bumblevue.config.inputVariant === 'filled'
        }
    ],
