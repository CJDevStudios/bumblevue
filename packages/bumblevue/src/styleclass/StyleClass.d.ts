 ...
 *
 * [Live Demo](https://bumblevue.org/styleclass)
 *
 * @module styleclass
 *
 */
import type { DesignToken, HintedString, PassThrough } from '@cjdevstudios/bumblevue-core';
import type { DirectiveHooks } from '@cjdevstudios/bumblevue-core/basedirective';
