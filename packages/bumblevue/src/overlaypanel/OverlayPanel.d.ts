 ...
 *
 * [Live Demo](https://bumblevue.org/popover)
 *
 * @module overlaypanel
 *
 */
import type { DefineComponent, EmitFn } from '@cjdevstudios/bumblevue-core';
import * as Popover from '@cjdevstudios/bumblevue/popover';
import 'vue';
