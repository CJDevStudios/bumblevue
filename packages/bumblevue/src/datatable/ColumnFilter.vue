...
<script>
import { absolutePosition, addStyle, focus, getAttribute, isTouchDevice } from '@cjdevstudios/bumbleuix-utils/dom';
import { ZIndex } from '@cjdevstudios/bumbleuix-utils/zindex';
import { FilterOperator } from '@cjdevstudios/bumblevue-core/api';
...
import FilterIcon from '@cjdevstudios/bumblevue-icons/filter';
import FilterFillIcon from '@cjdevstudios/bumblevue-icons/filterfill';
import FilterSlashIcon from '@cjdevstudios/bumblevue-icons/filterslash';
import PlusIcon from '@cjdevstudios/bumblevue-icons/plus';
import TrashIcon from '@cjdevstudios/bumblevue-icons/trash';
...
import Select from '@cjdevstudios/bumblevue/select';
    ...
    computed: {
        ...
        matchModes() {
            return (
                ...
                this.$bumblevue.config.filterMatchModeOptions[this.type].map((key) => {
                    return { label: this.$bumblevue.config.locale[key], value: key };
                })
            );
        },
        isShowMatchModes() {
        ...
        operatorOptions() {
            return [
                { label: this.$bumblevue.config.locale.matchAll, value: FilterOperator.AND },
                { label: this.$bumblevue.config.locale.matchAny, value: FilterOperator.OR }
            ];
        },
        noFilterLabel() {
            return this.$bumblevue.config.locale ? this.$bumblevue.config.locale.noFilter : undefined;
        },
        isShowOperator() {
        ...
        removeRuleButtonLabel() {
            return this.$bumblevue.config.locale ? this.$bumblevue.config.locale.removeRule : undefined;
        },
        addRuleButtonLabel() {
            return this.$bumblevue.config.locale ? this.$bumblevue.config.locale.addRule : undefined;
        },
        isShowAddConstraint() {
            return this.showAddButton && this.filters[this.field].operator && this.fieldConstraints && this.fieldConstraints.length < this.maxConstraints;
        },
        clearButtonLabel() {
            return this.$bumblevue.config.locale ? this.$bumblevue.config.locale.clear : undefined;
        },
        applyButtonLabel() {
            return this.$bumblevue.config.locale ? this.$bumblevue.config.locale.apply : undefined;
        },
        columnFilterButtonAriaLabel() {
            return this.$bumblevue.config.locale?.aria ? (this.overlayVisible ? this.$bumblevue.config.locale.aria.hideFilterMenu : this.$bumblevue.config.locale.aria.showFilterMenu) : undefined;
        },
        filterOperatorAriaLabel() {
            return this.$bumblevue.config.locale ? this.$bumblevue.config.locale.filterOperator : undefined;
        },
        filterRuleAriaLabel() {
            return this.$bumblevue.config.locale ? this.$bumblevue.config.locale.filterConstraint : undefined;
        },
