...
export default {
    ...
    computed: {
        headerCheckboxAriaLabel() {
            return this.$bumblevue.config.locale.aria ? (this.checked ? this.$bumblevue.config.locale.aria.selectAll : this.$bumblevue.config.locale.aria.unselectAll) : undefined;
        }
    },
    components: {
        CheckIcon,
