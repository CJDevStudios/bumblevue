 ...
 *
 * [Live Demo](https://www.bumblevue.org/multiselect/)
 *
 * @module multiselect
 *
 */
...
export interface MultiSelectProps {
    ...
    /**
     * Text to display when there are no options available. Defaults to value from BumbleVue locale configuration.
