...
import type { CheckboxPassThroughOptionType } from '@cjdevstudios/bumblevue/checkbox';
...
import type { RadioButtonPassThroughOptionType } from '@cjdevstudios/bumblevue/radiobutton';
import type { SelectPassThroughOptionType } from '@cjdevstudios/bumblevue/select';
import type { VirtualScrollerLoaderOptions } from '@cjdevstudios/bumblevue/virtualscroller';
...
export interface ColumnProps {
    ...
    /**
     * Type of data. It's value is related to BumbleVue.filterMatchModeOptions config.
     */
