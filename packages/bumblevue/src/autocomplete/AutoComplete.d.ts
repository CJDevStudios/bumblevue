 ...
 *
 * [Live Demo](https://www.bumblevue.org/autocomplete/)
 *
 * @module autocomplete
 *
 */
import type { DefineComponent, DesignToken, EmitFn, HintedString, Nullable, PassThrough } from '@cjdevstudios/bumblevue-core';
...
import type { VirtualScrollerItemOptions, VirtualScrollerPassThroughOptionType, VirtualScrollerProps } from '@cjdevstudios/bumblevue/virtualscroller';
...
export interface AutoCompleteProps<T = any, C = T> {
     ...
     */
    optionGroupLabel?: string | ((data: C) => string) | undefined;
    /**
     * Property name or getter function that refers to the children options of option group.
     */
    optionGroupChildren?: string | ((data: C) => any[]) | undefined;
    /**
    ...
    /**
     * Text to be displayed in hidden accessible field when filtering returns any results. Defaults to value from BumbleVue locale configuration.
     * @defaultValue '{0} results are available'
     */
    searchMessage?: string | undefined;
    /**
     * Text to be displayed in hidden accessible field when options are selected. Defaults to value from BumbleVue locale configuration.
     * @defaultValue '{0} items selected'
     */
    selectionMessage?: string | undefined;
    /**
     * Text to be displayed in hidden accessible field when any option is not selected. Defaults to value from BumbleVue locale configuration.
     * @defaultValue No selected item
     */
    emptySelectionMessage?: string | undefined;
    /**
     * Text to display when filtering does not return any results. Defaults to value from BumbleVue locale configuration.
