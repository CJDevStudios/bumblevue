 ...
 *
 * [Live Demo](https://www.bumblevue.org/password/)
 *
 * @module password
 *
 */
...
export interface PasswordProps extends Omit<InputHTMLAttributes, 'size'> {
    ...
    /**
     * Text to prompt password entry. Defaults to BumbleVue locale configuration.
     */
    ...
    /**
     * Text for a weak password. Defaults to BumbleVue locale configuration.
     */
    weakLabel?: string | undefined;
    /**
     * Text for a medium password. Defaults to BumbleVue locale configuration.
     */
    mediumLabel?: string | undefined;
    /**
     * Text for a strong password. Defaults to BumbleVue locale configuration.
     */
