import DynamicDialogEventBus from '@cjdevstudios/bumblevue/dynamicdialogeventbus';
import { BumbleVueDialogSymbol } from '@cjdevstudios/bumblevue/usedialog';
...
export default {
    install: (app) => {
        ...
        app.provide(BumbleVueDialogSymbol, DialogService);
    }
};
