 ...
 *
 * [Live Demo](https://www.bumblevue.org/cascadeselect/)
 *
...
export interface CascadeSelectProps<T = any> {
    ...
    /**
     * Text to be displayed when there are no options available. Defaults to value from BumbleVue locale configuration.
