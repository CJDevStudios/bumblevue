...
import InputNumber from '@cjdevstudios/bumblevue/inputnumber';
...
export default {
    ...
    computed: {
        inputArialabel() {
            return this.$bumblevue.config.locale.aria ? this.$bumblevue.config.locale.aria.jumpToPageInputLabel : undefined;
        }
    },
    components: {
