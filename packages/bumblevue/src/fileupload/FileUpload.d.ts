 ...
 *
 * [Live Demo](https://www.bumblevue.org/fileupload/)
 *
 * @module fileupload
 *
 */
...
export interface FileUploadProps {
    ...
    /**
     * Label of the choose button. Defaults to BumbleVue locale configuration.
     */
    chooseLabel?: string | undefined;
    /**
     * Label of the upload button. Defaults to BumbleVue locale configuration.
     */
    uploadLabel?: string | undefined;
    /**
     * Label of the cancel button. Defaults to BumbleVue locale configuration.
     * @defaultValue Cancel
     */
    cancelLabel?: string | undefined;
    /**
     * Whether to use the default upload or a manual implementation defined in uploadHandler callback. Defaults to BumbleVue locale configuration.
     */
