...
<script>
import { getNextElementSibling, getOuterWidth, getPreviousElementSibling } from '@cjdevstudios/bumbleuix-utils/dom';
...
import MinusIcon from '@cjdevstudios/bumblevue-icons/minus';
