...
const INLINE_EXTERNALS = [/@cjdevstudios\/bumblevue-core\/.*/, /@cjdevstudios\/bumblevue-icons\/.*/, '@cjdevstudios/bumbleuix-styled', /@cjdevstudios\/bumbleuix-utils\/.*/];
const EXTERNALS = [...GLOBAL_EXTERNALS, ...INLINE_EXTERNALS];

// alias
const ALIAS_ENTRIES = [
    {
        find: /^@cjdevstudios\/bumblevue\/(.*)$/,
    ...
    // @todo - Remove
    { find: '@cjdevstudios/bumblevue-core/api', replacement: path.resolve(__dirname, '../core/src/api/Api.js') },
    { find: '@cjdevstudios/bumblevue-core/base/style', replacement: path.resolve(__dirname, '../core/src/base/style/BaseStyle.js') },
    { find: '@cjdevstudios/bumblevue-core/base', replacement: path.resolve(__dirname, '../core/src/base/Base.js') },
    { find: '@cjdevstudios/bumblevue-core/basecomponent/style', replacement: path.resolve(__dirname, '../core/src/basecomponent/style/BaseComponentStyle.js') },
    { find: '@cjdevstudios/bumblevue-core/basecomponent', replacement: path.resolve(__dirname, '../core/src/basecomponent/BaseComponent.vue') },
    { find: '@cjdevstudios/bumblevue-core/basedirective', replacement: path.resolve(__dirname, '../core/src/basedirective/BaseDirective.js') },
    { find: '@cjdevstudios/bumblevue-core/baseeditableholder', replacement: path.resolve(__dirname, '../core/src/baseeditableholder/BaseEditableHolder.vue') },
    { find: '@cjdevstudios/bumblevue-core/baseinput', replacement: path.resolve(__dirname, '../core/src/baseinput/BaseInput.vue') },
    { find: '@cjdevstudios/bumblevue-core/config', replacement: path.resolve(__dirname, '../core/src/config/BumbleVue.js') },
    { find: '@cjdevstudios/bumblevue-core/service', replacement: path.resolve(__dirname, '../core/src/service/BumbleVueService.js') },
    { find: '@cjdevstudios/bumblevue-core/useattrselector', replacement: path.resolve(__dirname, '../core/src/useattrselector/UseAttrSelector.js') },
    { find: '@cjdevstudios/bumblevue-core/useid', replacement: path.resolve(__dirname, '../core/src/useid/UseId.js') },
    { find: '@cjdevstudios/bumblevue-core/usestyle', replacement: path.resolve(__dirname, '../core/src/usestyle/UseStyle.js') },
    { find: '@cjdevstudios/bumblevue-core/utils', replacement: path.resolve(__dirname, '../core/src/utils/Utils.js') },
    { find: '@cjdevstudios/bumblevue-core', replacement: path.resolve(__dirname, '../core/src/index.js') },
    { find: '@cjdevstudios/bumblevue-icons/baseicon/style', replacement: path.resolve(__dirname, '../icons/src/baseicon/style/BaseIconStyle.js') },
    { find: '@cjdevstudios/bumblevue-icons/baseicon', replacement: path.resolve(__dirname, '../icons/src/baseicon/BaseIcon.vue') }
];
...
function addLibrary() {
    ...
    ENTRY.format.umd({ name: 'BumbleVue', input: process.env.INPUT_DIR + 'umd/bumblevue.js', output: process.env.OUTPUT_DIR + 'umd/bumblevue', minify: true });
}
