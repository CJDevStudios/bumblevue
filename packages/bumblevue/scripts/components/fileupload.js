const FileUploadProps = [
    ...
    },
    {
        ...
        type: 'string',
        default: 'null',
        description: 'Label of the choose button. Defaults to BumbleVue locale configuration.'
    },
    {
        name: 'uploadLabel',
        type: 'string',
        default: 'Upoad',
        description: 'Label of the upload button. Defaults to BumbleVue locale configuration.'
    },
    {
        name: 'cancelLabel',
        type: 'string',
        default: 'Cancel',
        description: 'Label of the cancel button. Defaults to BumbleVue locale configuration.'
    },
    {
        name: 'customUpload',
        type: 'boolean',
