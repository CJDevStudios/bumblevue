        ...
        githubLink() {
            ...
            if (name) {
                if (this.docType === 'page') {
                    ...
                    return `https://github.com/CJDevStudios/bumblevue/tree/master/apps/showcase/pages/${fullPath}/`;
                }
                return `https://github.com/CJDevStudios/bumblevue/tree/master/apps/showcase/doc/${name}/`;
            }
            return 'https://github.com/CJDevStudios/bumblevue/tree/master/apps/showcase/';
        },
        chatGPTLink() {
