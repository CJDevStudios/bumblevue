<template>
    <DocSectionText v-bind="$attrs">
        <p>
            You can use BumbleVue and Vue.js from a CDN with a script tag. This approach does not involve any build step, and is suitable for enhancing static HTML. This guide uses
