<template>
    <DocSectionText v-bind="$attrs">
        <p>Items display a tooltip on hover when a standalone <BumbleVueNuxtLink to="/tooltip">Tooltip</BumbleVueNuxtLink> is present with a target that matches the items.</p>
    </DocSectionText>
    <div class="card">
