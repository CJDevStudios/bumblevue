<template>
    <DocSectionText v-bind="$attrs">
        <p>FloatLabel visually integrates a label with its form element. Visit <BumbleVueNuxtLink to="/floatlabel">FloatLabel</BumbleVueNuxtLink> documentation for more information.</p>
    </DocSectionText>
