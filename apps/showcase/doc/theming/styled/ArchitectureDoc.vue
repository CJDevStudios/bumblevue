<template>
    <DocSectionText v-bind="$attrs">
        <p>
            BumbleVue is a design agnostic library so unlike some other UI libraries it does not enforce a certain styling such as material design. Styling is decoupled from the components using the themes instead. A theme consists of two parts;
        ...
        <p>
            ...
            component. By defining your own design tokens as a custom preset, you'll be able to define your own style without touching CSS. Overriding the BumbleVue components using style classes is not a best practice and should be the last resort,
            design tokens are the suggested approach.
        </p>

        <h3>Video Tutorial</h3>
        <p>Watch the <b>BumbleVue Theming Demystified</b> series to learn more about the architecture with examples.</p>
