<template>
    <DocSectionText v-bind="$attrs">
        <p>
            ...
            <BumbleVueNuxtLink to="/virtualscroller">VirtualScroller</BumbleVueNuxtLink> component is utilized so refer to the API of VirtualScroller for more information about the available options.
        </p>
