<template>
    <DocSectionText id="accessibility" label="Accessibility" v-bind="$attrs">
        ...
        <p>Paginator is a standalone component used inside the DataTable, refer to the <BumbleVueNuxtLink to="/paginator">paginator</BumbleVueNuxtLink> for more information about the accessibility features.</p>
