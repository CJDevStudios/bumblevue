<template>
    <DocSectionText v-bind="$attrs">
        <p>A floating label appears on top of the input field when focused. Visit <BumbleVueNuxtLink to="/floatlabel">FloatLabel</BumbleVueNuxtLink> documentation for more information.</p>
    </DocSectionText>
