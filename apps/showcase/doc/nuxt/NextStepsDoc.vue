<template>
    <DocSectionText v-bind="$attrs">
        <p>Welcome to BumbleVue! Once you have BumbleVue up and running, we recommend exploring the following resources to gain a deeper understanding of the library.</p>
