<script setup lang="ts">
    ...
    const docs = [
        ...
        { id: 'icons', label: 'Icons', component: IconsDoc },
        ...
        { id: 'raisedtext', label: 'Raised Text', component: RaisedTextDoc },
        { id: 'outlined', label: 'Outlined', component: OutlinedDoc },
        { id: 'icononly', label: 'Icon Only', component: IconOnlyDoc },
        { id: 'badge', label: 'Badge', component: BadgeDoc },
        { id: 'buttongroup', label: 'Button Group', component: ButtonGroupDoc },
