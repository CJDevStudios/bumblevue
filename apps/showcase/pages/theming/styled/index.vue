<script setup lang="ts">
    ...
    const docs = [
        ...
        { id: 'presets', label: 'Presets', component: PresetsDoc },
        { id: 'reserved', label: 'Reserved Keys', component: ReservedKeysDoc },
        ...
        { id: 'darkmode', label: 'Dark Mode', component: DarkModeDoc },
        {
            ...
            label: 'Customization',
            children: [
                { id: 'definepreset', label: 'definePreset', component: DefinePresetDoc },
                { id: 'colorscheme', label: 'Color Scheme', component: ColorSchemeDoc },
                { id: 'primary', label: 'Primary', component: PrimaryDoc },
                { id: 'surface', label: 'Surface', component: SurfaceDoc },
                { id: 'noir', label: 'Noir', component: NoirDoc },
                { id: 'font', label: 'Font', component: FontDoc },
                { id: 'forms', label: 'Forms', component: FormsDoc },
                { id: 'focusring', label: 'Focus Ring', component: FocusRingDoc },
                { id: 'component', label: 'Component', component: ComponentDoc },
                { id: 'extend', label: 'Extend', component: ExtendDoc }
            ]
        },
        { id: 'scopedtokens', label: 'Scoped Tokens', component: ScopedTokensDoc },
        {
            id: 'utils',
            label: 'Utils',
            children: [
                { id: 'usepreset', label: 'usePreset', component: UsePresetDoc },
                { id: 'updatepreset', label: 'updatePreset', component: UpdatePresetDoc },
                { id: 'updateprimarypalette', label: 'updatePrimaryPalette', component: UpdatePrimaryPaletteDoc },
                { id: 'updatesurfacepalette', label: 'updateSurfacePalette', component: UpdateSurfacePaletteDoc },
                { id: 'dt', label: '$dt', component: DTDoc },
                { id: 'Palette', label: 'palette', component: PaletteDoc }
            ]
        },
        {
            id: 'csslayer',
            label: 'CSS Layer',
            description: 'The BumbleVue CSS layer only applies to styled mode when layering is enabled explicitly at theme configuration, in unstyled mode the built-in CSS classes are not included and as a result no layer is necessary.',
            children: [
                { id: 'specificity', label: 'Specificity', component: SpecificityDoc },
                { id: 'reset', label: 'Reset', component: ResetDoc }
            ]
        },
        { id: 'cssmodules', label: 'CSS Modules', component: CSSModulesDoc },
        { id: 'scale', label: 'Scale', component: ScaleDoc }
    ];
</script>
...
<template>
    <div>
        <Head>
            <Title>Styled Mode - BumbleVue</Title>
