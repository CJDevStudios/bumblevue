<script setup lang="ts">
    ...
    const docs = [
        ...
        { id: 'controlled', label: 'Controlled', component: ControlledDoc },
        {
            ...
            label: 'Selection',
            children: [
                { id: 'single', label: 'Single', component: SingleDoc },
        ...
        { id: 'filter', label: 'Filter', component: FilterDoc },
        {
            ...
            label: 'DragDrop',
            children: [
                { id: 'dragdrop-single', label: 'Single', component: SingleDragDropDoc },
                { id: 'dragdrop-multiple', label: 'Multiple', component: MultipleDragDropDoc }
            ]
        },
