<script setup lang="ts">
    ...
    const docs = [
        ...
        { id: 'dialogservice', label: 'Dialog Service', component: DialogServiceDoc },
        { id: 'open', label: 'Open', component: OpenDialogDoc },
        { id: 'customization', label: 'Customization', component: CustomizationDoc },
        { id: 'close', label: 'Close', component: CloseDialogDoc },
        { id: 'passingdata', label: 'Passing Data', component: PassingDataDoc },
