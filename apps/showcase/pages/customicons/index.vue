<template>
    <div>
        <Head>
            ...
            <Meta name="description" content="BumbleVue components can be used with any icon library using the templating features." />
        </Head>
            ...
            <div class="doc-main">
                <div class="doc-intro">
                    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-4">
                        <div class="flex-1">
                            <h1>Custom Icons</h1>
                            <p>BumbleVue components can be used with any icon library using the templating features.</p>
                        </div>
