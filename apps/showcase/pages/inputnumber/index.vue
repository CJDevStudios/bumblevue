<script setup lang="ts">
    ...
    const docs = [
        ...
        { id: 'numerals', label: 'Numerals', component: NumeralsDoc },
        { id: 'forms', label: 'Forms', component: FormsDoc },
        { id: 'locale', label: 'Locale', component: LocaleDoc },
        { id: 'currency', label: 'Currency', component: CurrencyDoc },
        { id: 'prefixsuffix', label: 'Prefix & Suffix', component: PrefixSuffixDoc },
        { id: 'buttons', label: 'Buttons', component: ButtonsDoc },
