<script setup lang="ts">
    ...
    const docs = [
        ...
        { id: 'states', label: 'States', component: StatesDoc },
        { id: 'resolvers', label: 'Resolvers', component: ResolversDoc },
        { id: 'validateon', label: 'ValidateOn', component: ValidateOnDoc },
        {
            id: 'formfield',
            label: 'FormField',
            children: [
                { id: 'formfield-import', label: 'Import', component: FormFieldDoc },
                { id: 'formfield-built-in', label: 'Built-in', component: BuiltInDoc },
                { id: 'formfield-non-primevue', label: 'Non BumbleVue', component: NonPrimeVueDoc },
                { id: 'formfield-resolver', label: 'Resolver', component: ResolverDoc },
                { id: 'formfield-template', label: 'Template', component: TemplateDoc }
            ]
        },
        { id: 'submit', label: 'Submit', component: SubmitDoc },
