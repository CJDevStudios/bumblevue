<script setup lang="ts">
    ...
    const docs = [
        ...
        { id: 'pt', label: 'Pass Through', component: PTDoc },
        { id: 'ptoptions', label: 'Pass Through Options', component: PTOptionsDoc },
        { id: 'ripple', label: 'Ripple', component: RippleDoc },
        { id: 'inputvariant', label: 'InputVariant', component: InputVariantDoc },
        { id: 'zindex', label: 'ZIndex', component: ZIndexDoc },
        {
            id: 'csp',
            label: 'CSP',
            children: [{ id: 'nonce', label: 'Nonce', component: NonceDoc }]
        },
        {
            id: 'locale',
            label: 'Locale',
            children: [
                { id: 'setlocale', label: 'Set Locale', component: SetLocaleDoc },
                { id: 'repository', label: 'Repository', component: RepositoryDoc },
                { id: 'localeapi', label: 'API', component: LocaleApiDoc }
            ]
        }
    ];
</script>
...
<template>
    <Head>
        <Title>Configuration - BumbleVue</Title>
        <Meta name="description" content="Application wide configuration for BumbleVue." />
    </Head>
    <div class="doc">
        <div class="doc-main">
            <div class="doc-intro">
                <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-4">
                    <div class="flex-1">
                        <h1>Configuration</h1>
                        <p>Application wide configuration for BumbleVue.</p>
                    </div>
