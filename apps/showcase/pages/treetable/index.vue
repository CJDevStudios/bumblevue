<script setup lang="ts">
    ...
    const docs = [
        ...
        { id: 'grid_lines', label: 'Grid Lines', component: GridLinesDoc },
        {
            id: 'loading',
            label: 'Loading',
            children: [
        ...
        },
        {
            ...
            children: [
                ...
                { id: 'removable_sort', label: 'Removable Sort', component: RemovableSortDoc }
            ]
        },
        { id: 'filter', label: 'Filter', component: FilterDoc },
        {
            ...
            children: [
                ...
                { id: 'row_selection_events', label: 'Events', component: RowSelectionEventsDoc }
            ]
        },
        { id: 'lazy_load', label: 'Lazy Load', component: LazyLoadDoc },
        {
            id: 'scroll',
            label: 'Scroll',
            children: [
        ...
        { id: 'contextmenu', label: 'ContextMenu', component: ContextMenuDoc },
