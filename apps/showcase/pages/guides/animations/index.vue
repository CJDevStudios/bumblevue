<template>
    <div>
        <Head>
            <Title>Animations - BumbleVue</Title>
            <Meta name="description" content="BumbleVue animations guide." />
        </Head>
                ...
                <div class="doc-intro">
                    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4 mb-4">
                        <div class="flex-1">
                            <h1>Animations</h1>
                            <p>
                                Various BumbleVue Components utilize native CSS animations to provide an enhanced user experience. The default animations are based on the best practices recommended by the usability experts. In case you need to
